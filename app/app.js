var appCfg ={
    navRoutes:[        
        ...
        {navItem:true, path:"/tour",name:"Tour",view:"app/views/tour.html"},
        {navItem:true, path:"/tickets",name:"Tickets",view:"app/views/tickets.html"},
        {navItem:true, path:"/about",name:"Home",view:"app/views/about.html"},
